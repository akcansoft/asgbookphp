...
<table border="0">
<tr><td>Adı Soyadı: <span style="color=red">*</span></td><td><input id="adsoyad" name="name" type="text" value="#ADI#"></td></tr>
...
<tr><td>&nbsp;</td>
<td>Kalan harf:
 <input type="text" size="4" name="gen" style="background-color: #FFF; border: none" readonly /></td>
</tr>
<tr><td valign="top"><p>Mesaj: <span style="color=red">*</span><p>
